...
/**
 * Shared chrome for the public, free "tools" pages (organic-SEO surfaces like
 * YouTube→Transcript). Slim brand bar + a "Try the full app" CTA, a centered
 * content column, and a cross-linking footer. Lives outside the (app) auth shell
 * so these pages are fully public and indexable.
 */
